...
const GOLD_GLOW_STYLE = {
  color: GOLD,
  textShadow: 'none',
};

const WHITE_GLOW_STYLE = {
  color: '#2c2c2c',
  textShadow: 'none',
};
  ...
  return (
    <section ref={sectionRef} id="date-location" style={{
      ...
      <div style={{
        ...
        <div style={{
          width: '100%',
          maxWidth: 'clamp(300px, 80vw, 480px)',
          textAlign: 'center',
          display: 'flex',
          flexDirection: 'column',
          alignItems: 'center',
          ...
          <div style={{ position: 'relative', width: '100%' }}>
            <div style={{
              ...
              <p style={{
                fontFamily: 'Gambarino',
                fontSize: 'clamp(0.62rem, 1.6vw, 0.82rem)',
                margin: '2px 0',
                lineHeight: 1.5,
                ...WHITE_GLOW_STYLE,
              }}>1:00 PM</p>
              ...
              <div style={{
                height: '1px',
                background: 'rgba(181,157,88,0.3)',
